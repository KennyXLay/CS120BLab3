...
tests = [ {'description': 'First test',
    ...
    'expected': [('PORTB',0x03)('PORTC',0x0F)],
    },
    {'description': 'second test',
    'steps': [ {'inputs': [('PINA',0xD3)], 'iterations': 1 } ],
    'expected': [('PORTB',0x0D)('PORTC',0x03)],
    },
    {'description': 'third test',
    'steps': [ {'inputs': [('PINA',0x4B)], 'iterations': 1 } ],
    'expected': [('PORTB',0x04)('PORTC',0x0B)],
    },
    ]
